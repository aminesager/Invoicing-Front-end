...
interface ExpenseInvoiceDownloadDialogProps {
  ...
  id: number;
  open: boolean;
  downloadExpenseInvoice: (template: string) => void;
  ...
  const body = (
    <div className={cn(className, 'grid grid-cols-2 gap-4')}>
      <div
        ...
        onClick={() => downloadExpenseInvoice('template1')}>
        <File />
      ...
      <div
        className="flex gap-2 items-center cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-500 rounded-lg p-4"
        onClick={() => downloadExpenseInvoice('template2')}>
        <File />
      ...
      <div
        className="flex gap-2 items-center cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-500 rounded-lg p-4"
        onClick={() => downloadExpenseInvoice('template3')}>
        <File />
